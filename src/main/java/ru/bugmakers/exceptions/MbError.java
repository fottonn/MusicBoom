...
public enum MbError {
    ...
    CME05("Общая ошибка", "Не корректное входящее сообщение"),
    ...
    SEE03("Ошибка отправки сообщения", "У пользоватея не заполнено в профиде поле email"),
    ...
    //Ошибки транзакций
    TRE01("Ошибка транзакицй", "Сумма вывода превышает досутпный лимит"),
    TRE02("Ошибка транзакицй", "Транзакция не найдена"),
    TRE03("Ошибка транзакицй", "Передан не корректный статус транзакции");
