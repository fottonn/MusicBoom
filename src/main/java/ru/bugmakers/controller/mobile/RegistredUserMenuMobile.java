...
public class RegistredUserMenuMobile extends MbController {
    ...
    public ResponseEntity<MbResponseToMobile> feedbackSend(@RequestBody FeedBackRequestMobile feedBackRequestMobile) {
    ...
    public ResponseEntity<MbResponseToMobile> logout(@RequestParam("session_id") String sessionId,
