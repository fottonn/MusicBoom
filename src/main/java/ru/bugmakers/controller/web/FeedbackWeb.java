...
import ru.bugmakers.dto.request.web.FeedBackRequest;
...
public class FeedbackWeb {
    ...
    public ResponseEntity<ResponseToWeb> artistFeedback(@RequestBody FeedBackRequest feedBackRequest) {
        HttpHeaders responseHeaders = new HttpHeaders();
        return new ResponseEntity<ResponseToWeb>(null, responseHeaders, HttpStatus.OK);
    }
    @RequestMapping(method = RequestMethod.POST, value = "user")
    public ResponseEntity<ResponseToWeb> userFeedback(@RequestBody FeedBackRequest feedBackRequest) {
        HttpHeaders responseHeaders = new HttpHeaders();
        return new ResponseEntity<ResponseToWeb>(null, responseHeaders, HttpStatus.OK);
    }
}
